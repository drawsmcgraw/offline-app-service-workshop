...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fad31b9ef260e2b560b345250e372ae99a84a10d6c8771bc8ff55cf42a6179fb.js',function(){input.required=false;search();});}
