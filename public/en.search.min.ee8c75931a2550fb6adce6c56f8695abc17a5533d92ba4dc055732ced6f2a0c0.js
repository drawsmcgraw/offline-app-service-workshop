...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9a8038afa8b9b9dcf1788814536a3818a6c4bfdee3cb400484b88d74a5ebceff.js',function(){input.required=false;search();});}
